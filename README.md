...
Kavach-CRS surgically rewrites vulnerable Python logic in-place, neutralizing exploits (SQLi, Command Injection, Path Traversal, Hardcoded Credentials, Flask Debug/RCE) while preserving 100% of normal system behavior.
...
| 5 | **PATCH** | patch/patcher.py | Applies the minimal diff, takes a timestamped backup before touching anything, supports rollback |
